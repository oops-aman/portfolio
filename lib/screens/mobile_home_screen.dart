          ...
          children: [
            ...
            ListTile(
              leading: IconButton(
                ...
                color: const Color.fromARGB(255, 168, 176, 201),
                onPressed: () {
                  method.launchURL("https://www.instagram.com/oops_aman22");
                },
                iconSize: 18.0,
              ),
              title: const Text(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              CustomText(
                text: "Building things for the Android.",
                textsize: 42.0,
              ...
              Padding(
                ...
                child: Wrap(
                  children: [
                    Text(
                      "I'm a student based in Ravangla, Sikkim having good problem-solving abilities and coding skills.  Currently, I am learning Mobile Apps Development using Flutter.",
                      style: GoogleFonts.workSans(
                        color: Colors.grey,
                        fontSize: 15.0,
                        letterSpacing: 2.75,
